...
{
public:
	BYTETracker(float track_thresh, float high_thresh, float match_thresh,
		int max_alive = 1000, int track_buffer = 30);
	~BYTETracker();

	vector<STrack> update(const vector<Object>& objects, NvDsFrameMeta* frame_meta);
