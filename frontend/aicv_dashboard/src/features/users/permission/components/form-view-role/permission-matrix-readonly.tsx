...
import type { IPermissionData, PermissionAction } from 'src/features/users/create-permission/components/form-create-role/types';
                        ...
                        <Column key={sectionName} gap={pxToRem(16)}>
                            ...
                            <Column gap={pxToRem(12)}>
                                {Object.entries(modules).map(([moduleName, availableActions]) => {
                                    const modulePermissions = data[sectionName]?.[moduleName] || [];
