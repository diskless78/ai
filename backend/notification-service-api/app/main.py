...
from app.core.sse.broker import Broker
...
from app.routes import notification_router, sse_router
from app.logger.logger import logger
from app.schemas.base import AppBaseResponseError
import uvicorn

# from app.core.firebase.firebase import Firebase
...
def init_routes(app: FastAPI):
    ...
    app.include_router(sse_router.router, prefix=BASE_URL, tags=["SSE API"])
